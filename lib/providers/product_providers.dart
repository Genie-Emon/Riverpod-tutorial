...
const List<Product> allProducts = [
  ...
  Product(id: '6', title: 'Blue Suitcase', price: 14, image: 'assets/products/suitcase.png'),
  Product(id: '7', title: 'Roller Skates', price: 14, image: 'assets/products/skates.png'),
  Product(id: '8', title: 'Electric Guitar', price: 14, image: 'assets/products/guitar.png'),
];
